...
class POSController
{
    ...
    public function index(): void
    {
        ...
        $produits = ProduitRepository::selectAll();
        ...
        $total = VenteService::calculerTotalPanier($panier);
        $utilisateurId = 1;
    ...
    public function addToCart(): void
    {
        ...
        SessionManager::setMessage(
            "{$produit->getLibelle()} ajoute au panier",
            'success'
        );
        header('Location: index.php');
        exit;
    ...
    public function removeFromCart(): void
    {
        ...
        if ($produitId > 0) {
            ...
            SessionManager::setMessage('Article retire du panier', 'success');
        }
    ...
    public function clearCart(): void
    {
        ...
        SessionManager::setMessage('Panier vide', 'success');
        header('Location: index.php');
        exit;
    }
    ...
    public function setClient(): void
    {
        ...
        if ($clientId > 0) {
            ...
            if ($client) {
                ...
                SessionManager::setMessage(
                    "Client {$client->getNomComplet()} selectionne",
                    'success'
                );
            } else {
            ...
            SessionManager::setMessage('Aucun client selectionne', 'warning');
        }
    ...
    public function validateSale(): void
    {
        ...
        if (!$clientId) {
            SessionManager::setMessage('Veuillez selectionner un client', 'error');
            header('Location: index.php');
            exit;
        }

        $result = VenteService::processSale(
            $clientId,
            $panier,
            $modeReglement,
            $montantVerse,
        ...
        if ($result['success']) {
            SessionManager::setMessage(
                "Vente enregistree - Facture: {$result['numero_facture']} - Total: " .
